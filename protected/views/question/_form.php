...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="row">
		<?php echo $form->labelEx($model,'option_a_label'); ?>
		<?php echo $form->textField($model,'option_a_label',array('size'=>60,'maxlength'=>63)); ?>
		<?php echo $form->error($model,'option_a_label'); ?>
	</div>

	<div class="row">
		<?php echo $form->labelEx($model,'option_b_label'); ?>
		<?php echo $form->textField($model,'option_b_label',array('size'=>60,'maxlength'=>63)); ?>
		<?php echo $form->error($model,'option_b_label'); ?>
	</div>
